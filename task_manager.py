...
"""Defined a fucntion to request input from user to provide the following:
...
correct format.
After all data is recieved read data to a text file
...
def gen_reports():
    ...
    tasks and iduvidual tasks for users.
        ...
        for line in user_overview_file:
            ...
            if i > 3:
                ...
                print(f"User:                     \t{data[0]}\n" 
                      ...
                      f"Percentage Incompleted:   \t{data[6]}%\n"
...
|vm - view my task      |''')
    ...
    if menu == 'r': reg_user(username)
    elif menu == 'a': add_task()
    elif menu == 'va': view_all()
    elif menu == 'vm': view_mine(username)
    elif menu == 'gr' and username == "admin" : gen_reports()
    elif menu == 'ds' and username == "admin": display_stats()               
